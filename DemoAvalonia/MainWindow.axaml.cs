...
namespace unvell.ReoGrid.WPFDemo
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            this.viewSheetTabVisibleCheckBox.IsChecked = grid.HasSettings(unvell.ReoGrid.WorkbookSettings.View_ShowHorScroll);
            this.viewVerticalScrollbarVisibleCheckBox.IsChecked = grid.HasSettings(unvell.ReoGrid.WorkbookSettings.View_ShowVerScroll);
        ...
        {
            grid.SetSettings(unvell.ReoGrid.WorkbookSettings.View_ShowSheetTabControl, viewSheetTabVisibleCheckBox.IsChecked??false);
        }
        ...
        {
            grid.SetSettings(unvell.ReoGrid.WorkbookSettings.View_ShowHorScroll, viewHorizontalScrollbarVisibleCheckBox.IsChecked??false);
        }

        private void View_VerticalScrollbar_Click(object sender, RoutedEventArgs e)
        {
            grid.SetSettings(unvell.ReoGrid.WorkbookSettings.View_ShowVerScroll, viewSheetTabNewButtonVisibleCheckBox.IsChecked ?? false);
        }
